...
UNION ALL
SELECT 'Verificado', COUNT(*) FROM dgo_rc WHERE estatus = 'Verificado' AND cel != '0'
UNION ALL
SELECT 'No contesta', COUNT(*) FROM dgo_rc WHERE estatus = 'No contesta' AND cel != '0'
UNION ALL
SELECT 'No participa', COUNT(*) FROM dgo_rc WHERE estatus = 'No participa' AND cel != '0'
UNION ALL
SELECT 'Datos incorrectos', COUNT(*) FROM dgo_rc WHERE estatus = 'Datos incorrectos' AND cel != '0'
UNION ALL
SELECT 'Marcar después', COUNT(*) FROM dgo_rc WHERE estatus = 'Marcar despues' AND cel != '0'
UNION ALL
SELECT 'Pendiente', COUNT(*) FROM dgo_rc WHERE estatus = 'Pendiente' AND cel != '0';`);
    res.json(result.rows);
  } catch (err) {
    console.error(err);
    res.status(500).json({ message: 'Error al obtener los usuarios' });
...
app.post('/api/call-por-usuario', async (req, res) => {
  ...
  SELECT 
    ...
    usuario_responsable 
  FROM dgo_rc 
  WHERE usuario_responsable = $1 AND estatus = $2 AND cel != '0'
...
app.post('/api/call-por-distrito', async (req, res) => {
  ...
  SELECT 
    ...
    usuario_responsable 
  FROM dgo_rc 
  WHERE usuario_responsable = $1 AND estatus = $2 AND distrito = $3 AND cel != '0'
  ORDER BY distrito ASC;
`;
...
WHERE v.usuario_responsable = $1 and v.estatus = $2 AND v.cel != '0'
GROUP BY 
    v.id_2,  
    v.nombre_c, 
    v.cel, 
